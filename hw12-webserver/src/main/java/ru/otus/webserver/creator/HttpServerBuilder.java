...
public class HttpServerBuilder {
    ...
    public HttpServerBuilder addServlet(HttpServlet servlet, String path) {
        context.addServlet(new ServletHolder(servlet), path);
        return this;
    }

    public HttpServerBuilder addFilter(Filter filter, String path, EnumSet<DispatcherType> dispatches) {
        context.addFilter(new FilterHolder(filter), path, dispatches);
        return this;
    }

    public Server build(int port) throws MalformedURLException {
    ...
    private ResourceHandler createResourceHandler() {
        ...
        URL fileDir = HttpServerBuilder.class.getClassLoader().getResource("static");
        if (fileDir == null) {
    ...
    private SecurityHandler createSecurityHandler(ServletContextHandler context) throws MalformedURLException {
        ...
        if (propFile == null) {
            ...
            propFile = HttpServerBuilder.class.getClassLoader().getResource("realm.properties");
        }
